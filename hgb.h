...
__DEVICE__ hgb_Linspace linspace_create(hgb_f32 start, hgb_f32 end, hgb_usize steps) {
    hgb_Linspace it;
...
__DEVICE__ hgb_f32 linspace_next(__PRIVATE__ hgb_Linspace *it) {
...
__DEVICE__ hgb_Mat3 hgb_npm(Primaries_Whitepoint pw) {
    hgb_f32 y = 1.0f;
