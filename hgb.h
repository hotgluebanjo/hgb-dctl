...
// Returns the positive difference between x and y:  x - y if x > y, +0 if
...
// magnitude in the interval [1/2, 1) or 0, and exp is updated with integer exponent
// value, whereas x = m * 2^exp
